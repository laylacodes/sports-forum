/**
 * @enum {number}
 */export const NODE_TYPE={ELEMENT:1,ATTR:2,TEXT:3,COMMENT:8,FRAGMENT:11};/**
 * @enum {any}
 */export const EMPTY={STR:"",NUM:1,OBJ:/** @type {any} */{},ARR:[],MAP:new Map,SET:new Set,DOM:/** @type {HTMLElement} */{},FUN:()=>{}};/**
 * @enum {number}
 */export const PATCH_TYPE={SET_ATTRIBUTE:0,REMOVE_ATTRIBUTE:1,NODE_VALUE:2,INSERT_BEFORE:3,REPLACE_CHILD:4,REMOVE_CHILD:5};/**
