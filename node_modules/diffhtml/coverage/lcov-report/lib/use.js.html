...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">lib</a> use.js</h1>
        <div class='clearfix'>
...
&nbsp;
  ...
  subscribe <span class="branch-0 cbranch-no" title="branch not covered" >&amp;&amp; subscribe(Internals);</span>
&nbsp;
  ...
  parseHook <span class="branch-0 cbranch-no" title="branch not covered" >&amp;&amp; ParseHookCache.add(parseHook);</span>
&nbsp;
...
&nbsp;
    ...
    // to cleanup).
    unsubscribe <span class="branch-0 cbranch-no" title="branch not covered" >&amp;&amp; unsubscribe(Internals);</span>
&nbsp;
    ...
    parseHook <span class="branch-0 cbranch-no" title="branch not covered" >&amp;&amp; ParseHookCache.delete(parseHook);</span>
  };
}
&nbsp;</pre></td></tr></table></pre>
