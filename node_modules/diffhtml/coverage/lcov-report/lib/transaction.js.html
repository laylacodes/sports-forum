...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">lib</a> transaction.js</h1>
        <div class='clearfix'>
...
<a name='L337'></a><a href='#L337'>337</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">2x</span>
...
&nbsp;
    ...
    const hasObserver = 'MutationObserver' in (globalThis.window <span class="branch-0 cbranch-no" title="branch not covered" >|| EMPTY.OBJ)</span>;
&nbsp;
...
&nbsp;
      ...
      oldNode.type = type;
&nbsp;
      if (!config.executeScripts || (hasModule() <span class="branch-0 cbranch-no" title="branch not covered" >&amp;&amp; type === 'nomodule')</span>) {
        return;
      }
&nbsp;
