...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">lib/node</a> patch.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">97.57% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>362/371</span>
            </div>
...
<a name='L372'></a><a href='#L372'>372</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">2x</span>
...
&nbsp;
        ...
        if (vTree === $$insertAfter) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >          const refNode = NodeCache.get(refTree);</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >          // Try and find the parentNode if it exists.</span>
<span class="cstat-no" title="statement not covered" >          if (refNode) {</span>
<span class="cstat-no" title="statement not covered" >            domNode = refNode.parentNode;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >            refTree = refNode.nextSibling ? refNode.nextSibling : null;</span>
<span class="cstat-no" title="statement not covered" >          }</span>
<span class="cstat-no" title="statement not covered" >        }</span>
&nbsp;
