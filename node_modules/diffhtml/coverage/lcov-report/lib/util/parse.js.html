...
<head>
    <title>Code coverage report for lib/util/parse.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">lib/util</a> parse.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">94.68% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>588/621</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>142/150</span>
            </div>
...
<a name='L622'></a><a href='#L622'>622</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">2x</span>
...
<span class="cline-any cline-yes">694x</span>
<span class="cline-any cline-yes">694x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// Adapted implementation from:
...
&nbsp;
    let tokenValue;
&nbsp;
    if (name === '') <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >      const match = rawAttrs.match(tokenEx);</span>
<span class="cstat-no" title="statement not covered" >      tokenValue = match ? match[0] : '';</span>
...
&nbsp;
          ...
          if (attributes[newName]) {
            attributes[newName] += hasSupValue ? supValue <span class="branch-0 cbranch-no" title="branch not covered" >: fallback;</span>
          }
          ...
          if (index === -1 &amp;&amp; options.parser.strict &amp;&amp; !selfClosing.has(name)) {
            ...
            const markup = html
              ...
              .map(line =&gt; line.replace(tokenEx, (value, index) =&gt; {
                if (!supplemental) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >                  return value;</span>
<span class="cstat-no" title="statement not covered" >                }</span>
&nbsp;
                const { tags, children, attributes } = supplemental;
                return tags[index] <span class="branch-0 cbranch-no" title="branch not covered" >|| children[index] <span class="branch-0 cbranch-no" title="branch not covered" ></span>|| attributes[index];</span>
              }))
              .slice(0, 3);
&nbsp;
            ...
            const caret = Array(
              (lookup ? lookup.index - 1 <span class="branch-0 cbranch-no" title="branch not covered" >: 0)</span> + closeMarkup.length - 1
            ).join(' ') + '^';
&nbsp;
...
&nbsp;
    if (bypassMatch || isClosingMatch || selfClosingMatch || selfClosing.has(name)) {
      if (process.env.NODE_ENV !== 'production') {
        if (currentParent &amp;&amp; name !== currentParent.rawNodeName &amp;&amp; options.parser.strict) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >          const nodeName = currentParent.rawNodeName;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >          // Find a subset of the markup passed in to validate.</span>
<span class="cstat-no" title="statement not covered" >          const markup = html</span>
<span class="cstat-no" title="statement not covered" >            .slice(tagEx.lastIndex - fullMatch.length)</span>
<span class="cstat-no" title="statement not covered" >            .split('\n')</span>
<span class="cstat-no" title="statement not covered" >            .map(line =&gt; line.replace(tokenEx, (value, index) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >              if (!supplemental) {</span>
<span class="cstat-no" title="statement not covered" >                return value;</span>
<span class="cstat-no" title="statement not covered" >              }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >              const { tags, children, attributes } = supplemental;</span>
<span class="cstat-no" title="statement not covered" >              return tags[index] || children[index] || attributes[index];</span>
<span class="cstat-no" title="statement not covered" >            }))</span>
<span class="cstat-no" title="statement not covered" >            .slice(0, 3);</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >          // Position the caret next to the first non-whitespace character.</span>
<span class="cstat-no" title="statement not covered" >          const lookup = spaceEx.exec(markup[0]);</span>
<span class="cstat-no" title="statement not covered" >          const caret = Array(lookup ? lookup.index : 0).join(' ') + '^';</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >          // Craft the warning message and inject it into the markup.</span>
<span class="cstat-no" title="statement not covered" >          markup.splice(1, 0, `${caret}</span>
<span class="cstat-no" title="statement not covered" >  Possibly invalid markup. Saw ${name}, expected ${nodeName}...</span>
<span class="cstat-no" title="statement not covered" >          `);</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >          // Throw an error message if the markup isn't what we expected.</span>
...
&nbsp;
      // Position the caret next to the first non-whitespace character.
      const lookup = spaceEx.exec(markup[0]);
      const caret = Array(lookup ? lookup.index <span class="branch-0 cbranch-no" title="branch not covered" >: 0)</span>.join(' ') + '^';
&nbsp;
      // Craft the warning message and inject it into the markup.
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Sat Apr 02 2022 00:03:27 GMT-0700 (Pacific Daylight Time)
            </div>
