...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">lib/util</a> make-measure.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">7x</span>
<span class="cline-any cline-yes">184x</span>
<span class="cline-any cline-yes">184x</span></td><td class="text"><pre class="prettyprint lang-js">import getConfig from "./config";
...
&nbsp;
    if (marks.has(name)) {
      const prevMark = marks.get(name) <span class="branch-0 cbranch-no" title="branch not covered" >|| 0;</span>
