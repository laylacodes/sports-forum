...
<head>
    <title>Code coverage report for lib/to-string.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">lib</a> to-string.js</h1>
        <div class='clearfix'>
...
function serializeVTree(vTree) {
  let output = '';
&nbsp;
  if (!vTree) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
