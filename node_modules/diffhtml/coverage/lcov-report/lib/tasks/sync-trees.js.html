...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">lib/tasks</a> sync-trees.js</h1>
        <div class='clearfix'>
...
&nbsp;
  if (process.env.NODE_ENV !== 'production') {
    if (!oldTree) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('Missing old tree during synchronization');</span>
<span class="cstat-no" title="statement not covered" >    }</span>
&nbsp;
    if (!newTree) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('Missing new tree during synchronization');</span>
<span class="cstat-no" title="statement not covered" >    }</span>
  }
&nbsp;
...
&nbsp;
  ...
  // Synchronize the top level elements.
    ...
    transaction.patches = syncTree(
      oldTree <span class="branch-0 cbranch-no" title="branch not covered" >|| null,</span>
      newTree <span class="branch-0 cbranch-no" title="branch not covered" >|| null,</span>
      [],
      state,
    );
  }
