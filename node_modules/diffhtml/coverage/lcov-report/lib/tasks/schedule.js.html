...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">lib/tasks</a> schedule.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">229x</span>
<span class="cline-any cline-yes">235x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { StateCache } from '../util/types';
...
<span class="cstat-no" title="statement not covered" ><span class="branch-0 cbranch-no" title="branch not covered" >    // Test if the active transaction is the same as the incoming by looking at</span></span>
<span class="cstat-no" title="statement not covered" >    // the mount. Then look and see if the state is rendering.</span>
<span class="cstat-no" title="statement not covered" >    else if (oldMount === newMount) {</span>
<span class="cstat-no" title="statement not covered" >      state = val;</span>
<span class="cstat-no" title="statement not covered" >      isRendering = true;</span>
...
&nbsp;
    ...
    transaction.abort();
&nbsp;
    const promise = nextTransaction <span class="branch-0 cbranch-no" title="branch not covered" >&amp;&amp; nextTransaction.promise </span>|| activeTransaction.promise || Promise.resolve();
&nbsp;
