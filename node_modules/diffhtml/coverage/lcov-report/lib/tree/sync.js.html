...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">lib/tree</a> sync.js</h1>
        <div class='clearfix'>
...
<a name='L336'></a><a href='#L336'>336</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">2x</span>
...
<span class="cline-any cline-yes">868x</span>
<span class="cline-any cline-yes">868x</span>
<span class="cline-any cline-yes">863x</span>
<span class="cline-any cline-yes">868x</span>
<span class="cline-any cline-yes">868x</span>
<span class="cline-any cline-yes">868x</span>
<span class="cline-any cline-yes">868x</span>
...
<span class="cline-any cline-yes">868x</span>
<span class="cline-any cline-yes">868x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import process from '../util/process';
import {
  SyncTreeHookCache,
  TransactionState,
  PATCH_TYPE,
...
&nbsp;
  ...
  if (newTree.nodeType === NODE_TYPE.ELEMENT) {
    ...
    const newAttributes = newTree.attributes <span class="branch-0 cbranch-no" title="branch not covered" >|| {};</span>
&nbsp;
...
&nbsp;
  /** @type {VTree[]} */
  const oldChildNodes = (oldTree.childNodes) <span class="branch-0 cbranch-no" title="branch not covered" >|| [];</span>
&nbsp;
