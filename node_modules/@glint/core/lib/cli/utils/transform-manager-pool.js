...
var _TransformManagerPool_rootSys, _TransformManagerPool_managers, _TransformManagerPool_loader;
...
export default class TransformManagerPool {
    constructor(sys) {
        ...
        __classPrivateFieldSet(this, _TransformManagerPool_rootSys, sys, "f");
    }
    get isPool() {
        return true;
    }
...
_TransformManagerPool_rootSys = new WeakMap(), _TransformManagerPool_managers = new WeakMap(), _TransformManagerPool_loader = new WeakMap();
