...
module("Integration | Component | Widget | home-logo", function(hooks) {
    ...
    test("mobile logo", async function(assert) {
        ...
        await render(template(`<MountWidget @widget="home-logo" />`, {
            eval () {
                return eval(arguments[0]);
            }
        }));
    ...
    test("logo with dark mode alternative", async function(assert) {
        ...
        assert.strictEqual(count("img#site-logo.logo-big"), 1);
        assert.strictEqual(query("#site-logo").getAttribute("src"), bigLogo);
        assert.strictEqual(query("picture source").getAttribute("media"), prefersDark, "includes dark mode media attribute");
        assert.strictEqual(query("picture source").getAttribute("srcset"), darkLogo, "includes dark mode alternative logo source");
    });
    ...
    test("dark color scheme and dark logo set", async function(assert) {
        ...
        assert.strictEqual(count("img#site-logo.logo-big"), 1);
        assert.strictEqual(query("#site-logo").getAttribute("src"), darkLogo, "uses dark logo");
    ...
    test("dark color scheme and dark logo not set", async function(assert) {
        ...
        assert.strictEqual(count("img#site-logo.logo-big"), 1);
        assert.strictEqual(query("#site-logo").getAttribute("src"), bigLogo, "uses regular logo on dark scheme if no dark logo");
    });
});
