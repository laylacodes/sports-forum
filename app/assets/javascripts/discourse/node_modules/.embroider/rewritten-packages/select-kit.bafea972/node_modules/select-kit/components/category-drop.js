...
export default ComboBoxComponent.extend({
  ...
  shortcuts: computed("value", "selectKit.options.{subCategory,noSubcategories}", function () {
    const shortcuts = [];
  ...
  allCategoriesLabel: computed("parentCategoryName", "selectKit.options.subCategory", function () {
  ...
  async search(filter) {
    if (this.siteSettings.lazy_load_categories) {
      ...
      return this.shortcuts.concat(results.sort((a, b) => {
  ...
  actions: {
    onChange(categoryId) {
      ...
      const route = this.editingCategory ? getEditCategoryUrl(category, categoryId !== NO_CATEGORIES_ID, this.editingCategoryTab) : getCategoryAndTagUrl(category, categoryId !== NO_CATEGORIES_ID, this.tagId);
