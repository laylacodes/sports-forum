/* import __COLOCATED_TEMPLATE__ from './category-row.hbs'; */
...
export default SelectKitRowComponent.extend({
  ...
  displayCategoryDescription: computed("selectKit.options.displayCategoryDescription", function () {
  ...
  topicCount: computed("categoryTotalTopicCount", "categoryTopicCount", "countSubcategories", function () {
    return this.countSubcategories ? this.categoryTotalTopicCount : this.categoryTopicCount;
  }),
  shouldDisplayDescription: computed("displayCategoryDescription", "categoryDescriptionText", function () {
