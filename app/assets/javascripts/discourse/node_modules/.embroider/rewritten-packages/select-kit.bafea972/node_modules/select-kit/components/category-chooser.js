...
export default ComboBoxComponent.extend({
  ...
  init() {
    ...
    if (this.siteSettings.lazy_load_categories && !Category.hasAsyncFoundAll([this.value])) {
  ...
  modifyNoSelection() {
    if (!isNone(this.selectKit.options.none)) {
      ...
      return this.defaultItem(null, htmlSafe(I18n.t(isString ? this.selectKit.options.none : "category.none")));
  ...
  content: computed("selectKit.filter", "selectKit.options.scopedCategoryId", "selectKit.options.prioritizedCategoryId", function () {
