...
import PluginApiMixin, { applyContentPluginApiCallbacks, applyOnChangePluginApiCallbacks } from "select-kit/mixins/plugin-api";
...
export default Component.extend(SELECT_KIT_OPTIONS, PluginApiMixin, UtilsMixin, {
  tagName: "details",
  ...
  collections: computed("selectedContent.[]", "mainCollection.[]", "errorsCollection.[]", function () {
