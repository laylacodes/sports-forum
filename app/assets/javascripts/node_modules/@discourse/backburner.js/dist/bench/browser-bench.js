define('browser-bench', function () { 'use strict';
	...
	;(function() {
	  ...
	  var freeDefine = typeof undefined$1 == 'function' && typeof undefined$1.amd == 'object' && undefined$1.amd && undefined$1;
	  ...
	  function runInContext(context) {
	    ...
	    function runScript(code) {
	      var anchor = freeDefine ? undefined$1.amd : Benchmark,
	  ...
	  if (typeof undefined$1 == 'function' && typeof undefined$1.amd == 'object' && undefined$1.amd) {
	    ...
	    undefined$1(['lodash', 'platform'], function(_, platform) {
	      return runInContext({
	        '_': _,
	        'platform': platform
	      });
	...
	var doYouEvenBench = function(suites) {
	  var suite = new benchmark.Suite();
	...
	var scheduleFlush = scenarios;

	function sharedSetup$3() {
	  var backburner = new this.Backburner(["sync", "actions", "routerTransitions", "render", "afterRender", "destroy", "rsvpAfter"]);
	...
	doYouEvenBench(suites);

});
//# sourceMappingURL=browser-bench.js.map
