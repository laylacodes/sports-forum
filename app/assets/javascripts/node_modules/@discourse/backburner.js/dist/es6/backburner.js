...
const NUMBER = /\d+/;
const QUEUE_ITEM_LENGTH = 5;
const TIMERS_OFFSET = 7;
...
class Queue {
    ...
    consoleTaskFor(index, inQueueBeingFlushed = false) {
    ...
    push(target, method, args, stack, consoleTask) {
    ...
    pushUnique(target, method, args, stack, consoleTask) {
...
class DeferredActionQueues {
     ...
     * @return queue
     */
    schedule(queueName, target, method, args, onceFlag, stack, consoleTask) {
